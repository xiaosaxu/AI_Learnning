 ...
 <article class="main">
	 ...
	 <section class="content">
		 ...
		 <form action="h5pay.php" method="post">
			 <div class="operation">
				 <a id="one" class="btn-green"  name="pay" style="margin-bottom: 20px" value="1"  onmouseover="get(1)">1元</a>
			 </div> 
			 <div class="operation">
				 <a id="two" class="btn-green"  name="pay" style="margin-bottom: 20px" value="2" onmouseover="get(2)">2元</a>
...
window.onload=function(){
    if(money_pay==1) document.getElementById("one").className="on";
    if(money_pay==2) document.getElementById("two").className="on";
}
function get(money){
    ...
    var arr=document.getElementsByClassName('btn-green');
